...
func Type(v int) predicate.UserActivity {
	return predicate.UserActivity(sql.FieldEQ(FieldType, v))
}
...
func TypeEQ(v int) predicate.UserActivity {
	return predicate.UserActivity(sql.FieldEQ(FieldType, v))
}

// TypeNEQ applies the NEQ predicate on the "type" field.
func TypeNEQ(v int) predicate.UserActivity {
	return predicate.UserActivity(sql.FieldNEQ(FieldType, v))
}

// TypeIn applies the In predicate on the "type" field.
func TypeIn(vs ...int) predicate.UserActivity {
	return predicate.UserActivity(sql.FieldIn(FieldType, vs...))
}

// TypeNotIn applies the NotIn predicate on the "type" field.
func TypeNotIn(vs ...int) predicate.UserActivity {
	return predicate.UserActivity(sql.FieldNotIn(FieldType, vs...))
}

// TypeGT applies the GT predicate on the "type" field.
func TypeGT(v int) predicate.UserActivity {
	return predicate.UserActivity(sql.FieldGT(FieldType, v))
}

// TypeGTE applies the GTE predicate on the "type" field.
func TypeGTE(v int) predicate.UserActivity {
	return predicate.UserActivity(sql.FieldGTE(FieldType, v))
}

// TypeLT applies the LT predicate on the "type" field.
func TypeLT(v int) predicate.UserActivity {
	return predicate.UserActivity(sql.FieldLT(FieldType, v))
}

// TypeLTE applies the LTE predicate on the "type" field.
func TypeLTE(v int) predicate.UserActivity {
	return predicate.UserActivity(sql.FieldLTE(FieldType, v))
}
