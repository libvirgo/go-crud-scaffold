...
func (uc *UserCreate) AddUserActivityIDs(ids ...int) *UserCreate {
	uc.mutation.AddUserActivityIDs(ids...)
	return uc
}

// AddUserActivity adds the "user_activity" edges to the UserActivity entity.
func (uc *UserCreate) AddUserActivity(u ...*UserActivity) *UserCreate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.UserActivityIDs(); len(nodes) > 0 {
