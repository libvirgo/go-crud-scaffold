...
func (c *Client) Intercept(interceptors ...Interceptor) {
	...
	c.UserActivity.Intercept(interceptors...)
}
...
// QueryUserActivity queries the user_activity edge of a User.
func (c *UserClient) QueryUserActivity(u *User) *UserActivityQuery {
...
type (
	hooks struct {
		AdminUser, User, UserActivity []ent.Hook
	}
	inters struct {
		AdminUser, User, UserActivity []ent.Interceptor
	}
)
